...
public class TokenConsumeParameters {
    private int tokenId;
    private double price;
    private Date startDate;
    private Date endDate;

    public TokenConsumeParameters(){}

    public TokenConsumeParameters(int _tokenId, double _price, Date _startDate, Date _endDate){
