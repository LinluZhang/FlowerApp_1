...
public class FlowerAddParameters {
    private String name;
    ...
    public FlowerAddParameters(){}

    public FlowerAddParameters(String _name, String _coverUrl, String _description, double _price, List<String> _imageUrls, boolean _hasChoice, String[] _choice, FlowerType _flowerType){
        this.name = _name;
